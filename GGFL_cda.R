...
#Coordinate optimization for GGFL

#arguments:
#  yli: list of group-wise vectors of an objective variable
#  Xli: list of group-wise matrixes of explanatory variables
...
GGFL.cda <- function(yli, Xli, D, thres=1e-5, Lambda=NULL, lambda.type=NULL, progress=FALSE, out.all=FALSE){
