...
#More general version of Coordinate optimization for GGFL
#This allows to use explanatory variables which are not took GGFL penalty.

#argument:
#  yli: list of group-wise vectors of an objective variable
#  Xli: list of group-wise matrixes of explanatory variables which are took GGFL penalty
#  Zli: list of group-wise matrixes of explanatory variables which are not took GGFL penalty
#  D: list of adjacency relations
#  thres: threshold for convergence judgement
#  progress: If TRUE, progress is displayed
#  out.all: 
#    If TRUE, results for all tuning parameters are output
